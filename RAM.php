...
<div class="container">    
  <div class="row">
    <div class="col-sm-4">
      ...
      <?php
        $result = mysqli_query($conn, "SELECT * FROM RAM WHERE itemID=1");
...
?>
    ...
    <div class="col-sm-4">
      <div style="background-color:#BCB8B1; border-color:#A00008;" class="panel panel-primary">
      <?php
        $result = mysqli_query($conn, "SELECT * FROM RAM WHERE itemID=2");
        if (mysqli_num_rows($result)) {
          while($row = mysqli_fetch_array($result)) {
            echo '<div style="background-color:#A00008; border-color:#A00008; font-family:Aldrich;" class="panel-heading">' . $row['itemName'] . '</div>';
            echo  '<div class="panel-body"><img src="' . $row['itemPic'] . '" class="img-responsive" style="width:100%" alt="Placeholder"></div>';
...
?>
    ...
    <div class="col-sm-4">
      <div style="background-color:#BCB8B1; border-color:#A00008;" class="panel panel-primary">
      <?php
        $result = mysqli_query($conn, "SELECT * FROM RAM WHERE itemID=3");
        if (mysqli_num_rows($result)) {
          while($row = mysqli_fetch_array($result)) {
            echo '<div style="background-color:#A00008; border-color:#A00008; font-family:Aldrich;" class="panel-heading">' . $row['itemName'] . '</div>';
            echo  '<div class="panel-body"><img src="' . $row['itemPic'] . '" class="img-responsive" style="width:100%" alt="Placeholder"></div>';
...
<div class="container">    
  ...
  <div class="col-sm-4">
      <div style="background-color:#BCB8B1; border-color:#A00008;" class="panel panel-primary">
      <?php
        $result = mysqli_query($conn, "SELECT * FROM RAM WHERE itemID=4");
        if (mysqli_num_rows($result)) {
          while($row = mysqli_fetch_array($result)) {
            echo '<div style="background-color:#A00008; border-color:#A00008; font-family:Aldrich;" class="panel-heading">' . $row['itemName'] . '</div>';
            echo  '<div class="panel-body"><img src="' . $row['itemPic'] . '" class="img-responsive" style="width:100%" alt="Placeholder"></div>';
...
?>
    ...
    <div class="col-sm-4">
      <div style="background-color:#BCB8B1; border-color:#A00008;" class="panel panel-primary">
      <?php
        $result = mysqli_query($conn, "SELECT * FROM RAM WHERE itemID=5");
        if (mysqli_num_rows($result)) {
          while($row = mysqli_fetch_array($result)) {
            echo '<div style="background-color:#A00008; border-color:#A00008; font-family:Aldrich;" class="panel-heading">' . $row['itemName'] . '</div>';
            echo  '<div class="panel-body"><img src="' . $row['itemPic'] . '" class="img-responsive" style="width:100%" alt="Placeholder"></div>';
...
?>
    ...
    <div class="col-sm-4">
      <div style="background-color:#BCB8B1; border-color:#A00008;" class="panel panel-primary">
      <?php
        $result = mysqli_query($conn, "SELECT * FROM RAM WHERE itemID=6");
        if (mysqli_num_rows($result)) {
          while($row = mysqli_fetch_array($result)) {
            echo '<div style="background-color:#A00008; border-color:#A00008; font-family:Aldrich;" class="panel-heading">' . $row['itemName'] . '</div>';
            echo  '<div class="panel-body"><img src="' . $row['itemPic'] . '" class="img-responsive" style="width:100%" alt="Placeholder"></div>';
