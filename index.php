...
<div style="background-color:#545454; margin-left:-15px;" class="container-fluid">
  <a href="#"><img style="float:left; width:10%; min-width:150px; height:auto;" src="assets/logo.png"/></a>
...
<div style="background-color: #333;">
  <h1 style="font-family: Aldrich; color:#9d9d9d; font-size:calc(1em + 1vw);">About Us</h1>
  <img src="assets/543268.jpg" alt="Coleman" width="113" height="170" style="border: 5px solid #555; float:left; margin:0px 10px">
  <p style="font-family: Aldrich; font-size: 20px; color:#9d9d9d; font-size:calc(0.5em + 1vw);">Henry Coleman has been a resident of Lexington for 20 years, moving here after acquiring his college degree. He began his career as a computer repairman, but wanted to do more than just repairs. Coleman knew many people who were not just needing repairs, but needed better parts for their computers.</p>
  <p style="font-family: Aldrich; font-size: 20px; color:#9d9d9d; font-size:calc(0.5em + 1vw);">In 2017, he decided to open his own business for selling, assembling, and repairing computers. Coleman’s Computers began its online presence a year later. It was an online storefront to display what products were in stock at the physical store. Coleman’s Computers began its part pickup program in 2020 to combat the global pandemic, as well as it’s part delivery services. Recently, Coleman’s Computers has pushed back toward in-person services, but still uses the online storefront to display products to be found in store.</p>
</div>
