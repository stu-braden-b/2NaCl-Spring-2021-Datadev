...
<div style="background-color: #333;">
  ...
  <p style="font-family: Aldrich; font-size: 20px; color:#9d9d9d; font-size:calc(0.5em + 1vw);">Henry Coleman is a resident of Lexington for 20 years, moving here after acquiring his college degree. He began his career as a computer repairman, but He wanted to do more than just repairs. He knew many people who were not just needing repairs, but needed better parts for their computers.</p>
  <p style="font-family: Aldrich; font-size: 20px; color:#9d9d9d; font-size:calc(0.5em + 1vw);">In 2017, he decided to open his own business for selling, assembling, and repairing computers. Coleman’s Computers began its online presence a year later, although it was merely an online storefront to display what products were in stock at the store.. Coleman’s Computers began its part pickup program in 2020 to combat the global pandemic, as well as it’s part delivery services. Recently, Coleman’s Computers has pushed back toward in-person services, but still uses the online storefront to display products to be found in store.</p>
</div>
